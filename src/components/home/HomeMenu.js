...
{
  /**Allow viewing website before auth*/
}
...
const HomeMenu = ({ onLoginClick, onRegisterClick }) => (
  <Row align="middle" style={{ width: "100%", padding: "0 20px 0 20px" }}>
    {" "}
    {/**Separates the subpage from auth buttons*/}
    <Col flex="auto">
      <Menu
        theme="light"
        mode="horizontal"
    ...
    <Col>
      <Row align="middle" style={{ width: "100%" }}>
        <Col style={{ margin: "0 10px" }}>
          <Button onClick={onRegisterClick} type="primary">
            Sign Up
          </Button>
        </Col>
        <Col style={{ margin: "0 10px" }}>
          <Button onClick={onLoginClick} type="default">
            Login
          </Button>
        </Col>
      </Row>

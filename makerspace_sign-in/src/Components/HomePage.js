  ...
  render() {
    return (
      <div className='PageContent'>
        ...
        <Content  Header="What is a MakerSpace?" Text={<p>The MakerSpace at Moorpark College is a place for students and faculty to explore new technologies, 
        ...
        MakerSpace is located in the Campus Center near the book store.</p>}/>
      </div>
